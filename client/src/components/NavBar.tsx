...
import TalaLogo from '../assets/tala/tala-darkbg.png'; // Ensure this path is correct
...
const navigation = [
  ...
  { name: 'Messages', href: '#', current: false, icon: ChatBubbleLeftIcon },
  { name: 'Requests', href: '#', current: false, icon: UserPlusIcon }, // Replaced with friend request icon
];
                  ...
                  <div className="flex space-x-4">
                    {navigation.map((item) => (
                      ...
                      >
                        ...
                        <span className="sr-only">{item.name}</span> {/* Hide text but accessible */}
                      </a>
                    ))}
                  </div>
                </div>
                ...
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current
                      ? 'bg-custom-highlight text-white'
                      : 'text-gray-300 hover:bg-custom-highlight hover:text-white',
                    'block rounded-md px-3 py-2 text-base font-medium items-center space-x-2'
                  )}
                >
                  <item.icon className="h-6 w-6" aria-hidden="true" />
